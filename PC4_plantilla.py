...
st.markdown("<h1 style='text-align: center;'>Las memorias de Francisco</h1>", unsafe_allow_html=True)
...
texto = """
Holo mi nombre es Francisco, estudio periodismo me gusta el futbol soy hincha de universitario de deportes y liverpool 
"""
...
texto_2 = """
Yo ya en su momento, ya fui estudiante de ingenieria informatica ya tenia algo de conocimientos basicos sobre programación sin embargo este curso me ayudo a reforzar mis conocimientos en el tema de la programación 
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Los graficos de Francisco</h1>", unsafe_allow_html=True)
...
graficos = ['Gráfico 1', 'Gráfico 2', 'mapa_3']
...
if grafico_seleccionado == 'Gráfico 1':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Este grafico muestra las estadisticas del culb Juventus de Italia </div>", unsafe_allow_html=True)
    sidebar.image("Histograma_Juventus.png", caption='Gráfico 1', width=500)
    pass
elif grafico_seleccionado == 'Gráfico 2':
    sidebar.markdown("<div style='text-align: justify'>Este graficó muestra el porcentaje de victorias y derrotas del equipo Milan</div>", unsafe_allow_html=True)
    sidebar.image("pastel_milan.png", caption='Gráfico 2', width=500)
    pass
elif grafico_seleccionado == 'mapa_3':
    sidebar.markdown("<div style='text-align: justify'>Este grafico muestra el numero de tarjetas rojas de la Serie A de Italia.</div>", unsafe_allow_html=True)
    sidebar.image("tarjetas_rojas (1).png", caption='mapa_3', width=500)
    pass
